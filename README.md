...
The **Analytical Design State** (ADS) determines which charts are valid, how R2 is calculated, and whether variance decomposition is available. SDS 4-6 (Incomplete) collapse to SDS 1-3 after data cleansing.
...
processbehavior is the **computational engine** for Bishop's VAS methodology. It handles data ingestion, SDS detection, residual computation, chart generation, and export.
...
For the **methodological foundation** — the theory behind VAS, SDS classification, and residual interpretation — see the forthcoming book by Dr. Thomas A. Bishop and Chris Nicholas.
