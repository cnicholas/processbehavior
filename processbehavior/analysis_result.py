...
# Re-export FocusedAnalysisResult for backward compat - the class lives
# in focused_result.py now, but old imports of the form
# `from processbehavior.analysis_result import FocusedAnalysisResult` and
# any pickled instances continue to resolve through this module path.
