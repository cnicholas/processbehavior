...
# ============================================================================
# Series-length precision of the moving-range sigma estimate
# ============================================================================

# 80% interval (p10, p90) of MRbar/d2 relative to the true sigma, for a stable
# normal process observed at n points, n = 3..30. Generated by
# validation/short_series_bands.py (seed 20260903, 100,000 replicates, an
# independent stream per n), contributed by @rabujamra in #114 / PR #119. Read
# as: at n=4, 80% of moving-range sigma estimates fall between 0.43x and 1.68x
# the truth. The spread narrows monotonically with n, so the n=30 row bounds
# every longer series. Stated as a fact in the design report; the library
# attaches no threshold, label, or warning to it.
MR_SIGMA_INTERVAL_80: dict[int, tuple[float, float]] = {
    3: (0.337, 1.810),
    4: (0.430, 1.676),
    5: (0.488, 1.593),
    6: (0.528, 1.526),
