"""
SDS 1 Data Analysis - 800 Observations
...
print("=" * 80)
print("SDS 1 DATA ANALYSIS - 800 OBSERVATIONS")
...
# Analyze with rational subgroups defined by FACTOR 1 and FACTOR 2
print("\n" + "=" * 80)
...
excel_file = 'sds1_800_analysis_results.xlsx'
...
5. Analyze main effects and interactions between FACTOR 1 and FACTOR 2
""")
